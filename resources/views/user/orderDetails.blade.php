                        ...
                        <form name="form" method="post" action="{{ url('storeOrder') }}">
                            ...
                            <fieldset class="wizard-fieldset show" wizard-title='Site Address' wizardFirst>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input type="text" id="city" class="form-control" name="city"
                                                required siteAddress />
                                            <label class="form-label" for="city">City <sup
                                                    class="text-red">*</sup></label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 mb-4">
                                        <div class="form-outline">
                                            <input type="text" id="landmark" class="form-control" name="landmark"
                                                required siteAddress />
                                            <label class="form-label" for="landmark">Landmark <sup
                                                    class="text-red">*</sup></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <!-- Default checkbox -->
                                        <div class="form-check" <?php if ($type != "agent") { ?>style="display: none;"
                                            <?php } ?>>
                                        ...
                                        <div class="form-check" <?php if ($type != "party") { ?>style="display: none;"
                                            <?php } ?>>
                                ...
                                <div class="row" <?php if ($type != "agent") { ?>style="display: none;" <?php } ?>>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input type="text" id="personName" class="form-control customerFields"
                            ...
                            <fieldset class="wizard-fieldset" wizard-title="Your Order">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-group  col-md-12 align-items-center justify-content-between m-0">
                                            ...
                                            <div class="input-group date form_datetime col-md-12 p-0" data-date=""
                                                data-date-format="dd-mm-yyyy - HH:ii p" data-link-field="dtp_input2">
                                                <input class="form-control" size="18" name="view_date_time"
                                                    type="text" value="" placeholder="Date & Time Supply"
                                                    id="datetime" pattern="\d{2}-\d{2}-\d{4} - \d{2}:\d{2} (am|pm)"
                                                    required autocomplete="off" />

                                                <button class="input-group-addon rounded"
                                                    style="background: transparent;border: 1px solid #bdbdbd;"><span
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <select class="form-select product_id" id="conGrade" name="conGrade" required
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input type="text" id="ratePerCube" class="form-control" readonly
                                                name="ratePerCube" />
                                        ...
                                        @foreach ($ServiceTypes as $ServiceType)
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input service" type="checkbox"
                                                    id="inlineCheckbox{{ $loop->iteration }}" name="ServiceType[]"
                                                    value="{{ $ServiceType->id }}" />
                                                <label class="form-check-label"
                                                    for="inlineCheckbox{{ $loop->iteration }}">{{ $ServiceType->service_name }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <fieldset class="wizard-fieldset" wizard-title="Billing Address">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input type="text" id="city" name="cities" class="form-control"
                                                required billAddress />
                                            <label class="form-label" for="city">City <sup
                                                    class="text-red">*</sup></label>
                                        </div>
                                ...
                                <div class="form-group clearfix">
                                    <a href="javascript:;"
                                        class="form-wizard-previous-btn btn btn-secondary float-start">Previous</a>
                                    <button type="submit"
                                        class="form-wizard-submit float-end btn btn-primary">Submit</button>
                                </div>
                            </fieldset>
